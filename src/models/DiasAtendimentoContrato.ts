...
<v-divider class="my-4" />
  ...
  <v-text-field v-model="responsavelDetalhes[key]" :label="label" outlined dense />
</v-col>
</v-row>
</div>
...
cancelarContrato = async (contrato: Contrato) => {
...
const confirmarAcao = async () => {
  try {
    ...
    } else if (modoCancelamento.value === 'inativar') {
